...
const JoinPage = () => {
    ...
    const { data, isLoading } = useGetBasicInfo(workspaceId as Id<"workspaces">);
        ...
        <div className="flex flex-col gap-y-4 items-center justify-center max-w-md">
            ...
            <VerificationInput
                ...
                classNames={{
                    ...
                    character:
                        "h-auto rounded-md border border-muted-foreground flex items-center justify-center text-lg font-md text-muted-foreground",
